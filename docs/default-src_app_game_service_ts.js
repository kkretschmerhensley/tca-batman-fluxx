...
/* harmony export */ });
/* harmony import */ var _convertToAttr__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./convertToAttr */ 7386);
/* harmony import */ var _convertToNative__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./convertToNative */ 8981);
/* harmony import */ var _marshall__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./marshall */ 9010);
/* harmony import */ var _models__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./models */ 207);
/* harmony import */ var _unmarshall__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./unmarshall */ 615);
...
/* harmony export */ });
/* harmony import */ var _convertToNative__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./convertToNative */ 8981);
...
/* harmony export */ });
/* harmony import */ var C_Users_karly_github_tca_batman_fluxx_local_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@angular-devkit/build-angular/node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 1415);
/* harmony import */ var _aws_sdk_util_dynamodb__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @aws-sdk/util-dynamodb */ 623);


const saveGameToCloud = /*#__PURE__*/function () {
  var _ref = (0,C_Users_karly_github_tca_batman_fluxx_local_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (email, appName, timestamp, gameResult) {
    const dynamoGame = {
      pk: email,
...
const loadGamesFromCloud = /*#__PURE__*/function () {
  var _ref2 = (0,C_Users_karly_github_tca_batman_fluxx_local_node_modules_angular_devkit_build_angular_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (email, appName) {
...
/* harmony import */ var _TcaCloudApi__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./TcaCloudApi */ 4183);
...
let GameService = class GameService {
    constructor(storageSvc) {
        ...
        this.addGameResult = (r) => (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            ...
            yield (0,_TcaCloudApi__WEBPACK_IMPORTED_MODULE_0__.saveGameToCloud)(this.emailAddress, "tca-batman-fluxx", r.end, r);
        });
        this.currentGame = {
            start: ""
        };
        ...
        this.calculateGamesWon = () => (this.gameResults.filter(x => x.gamesWon).length);
        this.calculateGamesLost = () => (this.gameResults.filter(x => x.gamesLost).length);
        this.calculateShortestGame = () => (Math.min(...this.gameResults.map(x => Date.parse(x.end) - Date.parse(x.start))));
        this.calculateLongestGame = () => (Math.max(...this.gameResults.map(x => Date.parse(x.end) - Date.parse(x.start))));
        this.calculateAvergeNumberOfRules = () => (this.gameResults.reduce((acc, x) => acc + x.numberOfRules, 0) / this.gameResults.length);
        this.calculateAvergeNumberOfGoals = () => (this.gameResults.reduce((acc, x) => acc + x.numberOfGoals, 0) / this.gameResults.length);
        this.calculateAvergeNumberOfKeepers = () => (this.gameResults.reduce((acc, x) => acc + x.numberOfKeepers, 0) / this.gameResults.length);
        this.calculateAvergeNumberOfCreepers = () => (this.gameResults.reduce((acc, x) => acc + x.numberOfCreepers, 0) / this.gameResults.length);
        ...
        this.init = () => (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            ...
            if (this.emailAddress.length > 0) {
                this.gameResults = (_b = yield (0,_TcaCloudApi__WEBPACK_IMPORTED_MODULE_0__.loadGamesFromCloud)(this.emailAddress, "tca-batman-fluxx")) !== null && _b !== void 0 ? _b : [];
            }
        });
        this.emailAddress = "";
