...
let PickerInternal = class {
  ...
  componentWillLoad() {
    (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_1__.g)(this.el).addEventListener('focusin', this.onFocusIn);
    (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_1__.g)(this.el).addEventListener('focusout', this.onFocusOut);
  }
  render() {
